        ...
        btn.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                ...
                if(id.length ()==0||type.length ()==0||name.length ()==6||chember.length ()==9||mobile.length()==8||fees.length ()==6){
                    ...
                    db.addDoctorDatabase (id,type,name,chember,mobile,fees);
                    Toast.makeText (getApplicationContext (),"Add Doctor Successfully!",Toast.LENGTH_SHORT).show ();
                    startActivity (new Intent (AddDoctor.this,AdminActivity.class));
                }
            }
        });
    }
